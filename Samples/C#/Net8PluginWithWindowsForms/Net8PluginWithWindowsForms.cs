/*  Sample: Net8 Plugin with Windows Forms
 *
 *  This sample illustrates how to create Net8 plugin with Windows Forms.
 *
...
{
  public class Net8PluginWithWindowsForms : Renga.IPlugin
  {
    ...
    public IAction CreateAction(IUI ui)
    {
      ...
      action.DisplayName = "Net8 plugin with Windows Forms";
